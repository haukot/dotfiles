...
;
(function(b){b.fn.extend({dragout:function(){this.length>0&&b(this).each(function(){var a=this.getAttribute("href");if(a.indexOf("?/")!=-1){a=a.split("?/");a=":"+a[1]+":"+a[0];}else{a='::'+a}this.addEventListener("dragstart",function(c){c.dataTransfer.setData("DownloadURL",a)},false)})}})})(jQuery);
