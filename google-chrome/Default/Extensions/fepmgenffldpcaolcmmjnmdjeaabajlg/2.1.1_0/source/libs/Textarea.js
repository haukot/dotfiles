...
enyo.kind({
    ...
    create: function() {
        ...
        {
            this.$.input.maxTextHeight = this.maxTextHeight.substr(0, this.maxTextHeight.length-3); //send to basicTextArea and strip "px;" from it
        }
    },
    destroy: function() {
...
//          var h = ((this.node.scrollHeight > this.maxTextHeight) ? this.maxTextHeight:this.node.scrollHeight);
          var h = ((this.node.scrollHeight > this.maxTextHeight) ? this.node.scrollHeight:this.maxTextHeight);
//          var h = this.maxTextHeight;
